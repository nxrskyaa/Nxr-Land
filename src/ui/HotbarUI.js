...
const REFRESH_EVENTS = ['economy:purchased', 'economy:sold', 'crop:planted', 'crop:harvested', 'hotbar:selected', 'quest:completed', 'reward:daily-claimed', 'reward:milestone-claimed'];
