...
export class NatureFactory {
  ...
  tree(x, z, scale = 1, tint = false) {
    ...
    const crown = new THREE.Mesh(this.geometry.crown, tint ? this.materials.leafLight : this.materials.leaf);
    crown.scale.set(1, 0.92, 1);
    const crown2 = new THREE.Mesh(this.geometry.crownSmall, this.materials.leafLight);
